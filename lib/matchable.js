...
function expressionMatcher(expr, type) {
    ...
    if (expr == null || (isArray(expr) && !expr.length))
        ...
        isMatch = (0, micromatch_1.matcher)(expr);
    else if (isArray(expr)) {
        isMatch = (0, micromatch_1.matcher)(`(${(0, iter_tools_es_1.stringFrom)((0, iter_tools_es_1.joinWithSeq)('|', (0, iter_tools_es_1.filter)(isString, expr)))})`);
    }
    else
