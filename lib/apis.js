    ...
    async write(path, content, options = {}) {
        ...
        if (!accessor) {
            throw new errawr_1.Errawr((0, errawr_1.rawr)('macrome has no accessor for writing to {ext} files'), {
                info: { ext: (0, path_1.extname)(path), path },
            });
        }
        ...
        let fd;
        try {
            fd = await (0, promises_1.open)(this.resolve(path), 'a+');
            ...
            await fd.truncate();
            await accessor.write(path, file, Object.assign(Object.assign({}, (0, fs_1.buildOptions)(options)), { fd }));
            await fd.close();
    ...
    async __generate(path, deps, cb) {
        ...
        try {
            ...
            if (targetGeneratedFrom) {
                ...
                if (this.resolve(change.path) === (0, path_1.resolve)((0, path_1.dirname)(this.resolve(path)), fromPath) &&
